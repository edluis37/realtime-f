...
import (
	...
	"fmt"
	"net/http"
	"rtf/luisamayateam/internal/model"
	"strings"
)
...
func (s *server) handlePosts(w http.ResponseWriter, r *http.Request) {
	...
	default:
		s.error(w, http.StatusMethodNotAllowed, errors.New(" Ups..No such method "))
	}
}
...
func (s *server) handleCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	if err == http.ErrNoCookie {
		s.error(w, http.StatusUnauthorized, errors.New("Nope! Authorized"))
		return
	}
